...
from dagster import Definitions, define_asset_job, ScheduleDefinition, MetadataValue, OpExecutionContext
...
# Jobs
# --------------------------------------------------------
hackernews_topstories_job = define_asset_job(
    name="hackernews_topstories_job",
    selection=[hackernews_topstory_ids, hackernews_topstories, hackernews_topstories_word_cloud]
)
...
# --------------------------------------------------------
defs = Definitions(
    assets=[hackernews_topstory_ids, hackernews_topstories, hackernews_topstories_word_cloud],
    jobs = [hackernews_topstories_job]
)
